...
func StoMap_chouyangwancheng_mode1(s string)map[string]string{
	...
	mkr["生产日期"]=FindFdval(sel4html,"购进日期")+FindFdval(sel4html,"生产日期")+FindFdval(sel4html,"加工日期")
...
func StoMap_chouyangwancheng_full(s string)map[string]string{
	...
	mkr["抽样基础信息_食品分类"]=FindFdval(sel0html,"食品分类")
	...
	mkr["抽检场所信息_所在地"]=FindFdval(sel2html,"所在地")
	...
	mkr["抽样生产企业信息_所在地"]=FindFdval(sel3html,"所在地")
